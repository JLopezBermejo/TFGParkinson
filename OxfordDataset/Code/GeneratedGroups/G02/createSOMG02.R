#ESTE ENTRENAMIENTO ES IGUAL QUE G01, CAMBIANDO EL RLEN 1000->2000
#TAMBIEN SE CAMBIA EL RATIO DE APRENDIZAJE (0.05,0,01) -> (0.01,0.005)
...
directory <- paste(directory,'/G02/G02_SC_22_10x10.csv',sep='') 
...
G02SOM <- som(dfScaled, grid = somgrid(10,10,"hexagonal"), alpha = c(0.01, 0.005), rlen = 2000,init = redInit)
